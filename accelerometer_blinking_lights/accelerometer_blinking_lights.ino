...
//int interruptPin2 = 3;         //Setup ADXL362 interrupt output to Interrupt 1 (digital pin 3)
...
// if ADXL362 is asleep, call LowPower.powerdown  
  if(interruptStatus == 0) { 
    ...
    digitalWrite(ledYellow, LOW);    // Turn off LED as visual indicator of asleep
...
// if ADXL362 is awake, report XYZT data to Serial Monitor
    ...
    delay(10);
    //digitalWrite(led, HIGH);    // Turn on LED as visual indicator of awake
